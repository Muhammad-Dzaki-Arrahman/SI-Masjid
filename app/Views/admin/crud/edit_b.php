...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Edit Berita</h6>
        </nav>
      </div>
    </nav>
    <!-- End Navbar -->
  ...
  <form class="card-body" action="/admin/update-userb/<?= $berita['id_berita'] ?>"  method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="slug_berita" name="slug_berita" value="<?= $berita['slug_berita'] ?>" required>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <textarea id="deskripsi" name="deskripsi" class="form-control" rows="5" required><?= $berita['deskripsi'] ?></textarea>
  </div>
