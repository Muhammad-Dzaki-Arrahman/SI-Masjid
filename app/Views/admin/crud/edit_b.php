...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <form action="/admin/update-userb/<?= $berita['id_berita'] ?>"  method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="slug_berita" name="slug_berita" value="<?= $berita['slug_berita'] ?>">
  </div>
    <div class="form-group">
