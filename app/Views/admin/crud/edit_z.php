...
<body class="g-sidenav-show   bg-gray-100">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Zakat </li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Zakat</h6>
        </nav>
      </div>
    </nav>
    <!-- End Navbar -->
  ...
  <form action="/admin/update-userz/<?= $zakat['id_zakat'] ?>" method="post">
  <div class="form-group">
    <label for="nama">Nama</label>
    <input type="text" class="form-control" id="nama" name="nama" value="<?= $zakat['nama'] ?>">
  </div>
  <div class="form-group">
    <label for="tanggal">Tanggal</label>
    <input type="text" class="form-control" id="tanggal" name="tanggal" value="<?= $zakat['tanggal'] ?>">
  </div>
    <div class="form-group">
    <label for="jenis_zakat">Jenis Zakat</Tabel>
    <input type="text" class="form-control" id="jenis_zakat" name="jenis_zakat" value="<?= $zakat['jenis_zakat']?>">
  </div>
    <div class="form-group">
    <label for="jumlah">Jumlah</label>
    <input type="text" class="form-control" id="jumlah" name="jumlah" value="<?= $zakat['jumlah'] ?>">
  </div>
  <button type="submit" class="btn btn-primary">Submit</button>
  <a href="/zakat"><button type="button" class="btn btn-warning">Kembali</button></a>
</form>
          </div>
        </div>
      </div>
