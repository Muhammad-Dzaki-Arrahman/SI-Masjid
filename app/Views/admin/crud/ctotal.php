...
<form action="storettl" method="post">
  ...
  <div class="form-group">
    ...
    <div class="form-group">
    <label for="jumlah_km">Jumlah Kas Masuk</label>
    <input type="text" class="form-control" id="jumlah_km" name="jumlah_km">
  </div>
  <div class="form-group">
    <label for="jumlah_kk">Jumlah Kas Keluar</label>
