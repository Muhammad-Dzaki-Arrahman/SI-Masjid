...
<body class="g-sidenav-show   bg-gray-100">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Total Kas </li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Total Kas</h6>
        </nav>
      </div>
    </nav>
    <!-- End Navbar -->
  ...
  <form action="/admin/update-usert/<?= $total['id_total'] ?>" method="post">
  <div class="form-group">
    <label for="total">Tahun</label>
    <input type="text" class="form-control" id="" name="tahun" value="<?= $total['tahun'] ?>">
  </div>
  <div class="form-group">
    <label for="bulan">Bulan</label>
    <input type="text" class="form-control" id="bulan" name="bulan" value="<?= $total['bulan'] ?>">
  </div>
    <div class="form-group">
    <label for="jumlah_km">Jumlah Kas Masuk</Tabel>
    <input type="text" class="form-control" id="jumlah_km" name="jumlah_km" value="<?= $total['jumlah_km']?>">
  </div>
    <div class="form-group">
    <label for="jumlah_kk">Jumlah Kas Keluar</Tabel>
    <input type="text" class="form-control" id="jumlah_kk" name="jumlah_kk" value="<?= $total['jumlah_kk']?>">
  </div>
    <div class="form-group">
    <label for="total">Total</label>
    <input type="text" class="form-control" id="total" name="total" value="<?= $total['total'] ?>">
  </div>
  <button type="submit" class="btn btn-primary">Submit</button>
  <a href="/total"><button type="button" class="btn btn-warning">Kembali</button></a>
</form>
          </div>
        </div>
      </div>
