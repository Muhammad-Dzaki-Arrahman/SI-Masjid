...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <form action="/admin/update-userkk/<?= $kaskeluar['id_kaskeluar'] ?>" method="post">
  <div class="form-group">
    <label for="nama">Nama</label>
    <input type="text" class="form-control" id="nama" name="nama" value="<?= $kaskeluar['nama'] ?>">
  </div>
  <div class="form-group">
    <label for="jumlah">Jumlah</label>
    <input type="text" class="form-control" id="jumlah" name="jumlah" value="<?= $kaskeluar['jumlah'] ?>">
  </div>
    <div class="form-group">
    <label for="tanggal">Tanggal</Tabel>
    <input type="date" class="form-control" id="tanggal" name="tanggal" value="<?= $kaskeluar['tanggal']?>">
  </div>
    <div class="form-group">
    <label for="keterangan">Keterangan</label>
    <input type="text" class="form-control" id="keterangan" name="keterangan" value="<?= $kaskeluar['keterangan'] ?>">
  </div>
  <button type="submit" class="btn btn-primary">Submit</button>
  <a href="/kaskeluar"><button type="button" class="btn btn-warning">Kembali</button></a>
</form>
          </div>
        </div>
      </div>
