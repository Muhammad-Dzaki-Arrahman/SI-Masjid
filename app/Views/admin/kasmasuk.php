                    ...
                    <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-secondary mb-0">Hamba Allah</p>
                          </div>
                        </div>
                    </td>
                    <td><?php echo $ksm['jumlah']; ?></td>
                    <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success"><?= $ksm['tanggal']?></span>
                      </td>
                    <td><?php echo $ksm['keterangan']; ?></td>
                <td>
                  <div>
                  <a href="/admin/crud/edit_km/<?= $ksm['id_kasmasuk'] ?>"><button type="button" class="btn btn-warning mr-3">Edit</button></a>
                  <a href="/admin/delete-userkm/<?= $ksm['id_kasmasuk'] ?>"><button type="button" class="btn btn-danger mr-3">Delete</button></a>
                  </div>
                </td>
                </tr>
                    <?php
