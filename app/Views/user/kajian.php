    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
                ...
                <h2 class="display-5 text-uppercase mb-0">KAJIAN MASJID TAWAKAL</h2>
            </div>
            <div class="row g-5">
                <div class="col-md-6">
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-md-6 text-center text-md-start">
                    <p class="mb-md-0">&copy; <a class="text-white" href="#">Sistem Informasi Masjid</a>. All Rights Reserved.</p>
                </div>
