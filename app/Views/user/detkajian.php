...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="/kajian" class="nav-item nav-link active">Kajian</a>
    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-8">
                <!-- Blog Detail Start -->
                <a href="/kajian"><button type="button" class="btn btn-primary ps-3 mb-4"><i class="bi-arrow-left"></i></button></a>
                <div class="mb-5">
                    <img class="img-fluid w-100 rounded mb-5" src="<?= base_url('usr')?>/img/blog-1.jpg" alt="">
                    <h1 class="text-uppercase mb-4"><?= $kegiatan['judul_kajian'] ?></h1>
